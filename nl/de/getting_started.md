...
Dieses Lernprogramm verwendet die Beispielapp [compose-rabbitmq-helloworld-nodejs](https://github.com/IBM-Cloud/compose-rabbitmq-helloworld-nodejs), um die Verwendung von Node.js zur Herstellung einer Verbindung zu einem {{site.data.keyword.composeForRabbitMQ_full}}-Service mithilfe der bereitgestellten Berechtigungsnachweise zu veranschaulichen. Die Anwendung erstellt eine Datenbank, liest daraus und schreibt darin. Dabei nutzt sie Daten, die über die Webschnittstelle der App bereitgestellt werden.
{: shortdesc}
...
## Schritt 10: Prüfen, ob die App mit Ihrem {{site.data.keyword.composeForRabbitMQ}}-Service verbunden ist
