...
# 시작하기 튜토리얼
이 튜토리얼에서는 [compose-rabbitmq-helloworld-nodejs](https://github.com/IBM-Cloud/compose-rabbitmq-helloworld-nodejs) 샘플 앱을 사용함으로써, Node.js를 사용하여 {{site.data.keyword.composeForRabbitMQ_full}} 서비스에 연결하는 방법을 보여줍니다. 이 애플리케이션은 앱의 웹 인터페이스를 통해 제공된 데이터를 사용하여 데이터베이스를 작성하고 읽기 및 쓰기를 수행합니다.
{: shortdesc}
...
## 8단계: 앱이 {{site.data.keyword.composeForRabbitMQ}} 서비스에 연결되었는지 확인
...
앱을 {{site.data.keyword.cloud_notm}}에 푸시하지 않고 로컬에서 실행하여 {{site.data.keyword.composeForRabbitMQ}} 서비스 인스턴스와의 연결을 테스트할 수 있습니다. 서비스에 연결하려면 서비스 신임 정보 세트를 작성해야 합니다.
