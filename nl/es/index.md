...
## Creación de una instancia del servicio Compose for RabbitMQ

[Cree una instancia de {{site.data.keyword.composeForRabbitMQ}}](https://console.ng.bluemix.net/catalog/services/compose-for-rabbitmq/).
...
## Gestión de Compose for RabbitMQ
...
## Conexión a Compose for RabbitMQ
...
## Conexión de una aplicación {{site.data.keyword.cloud_notm}} a Compose for RabbitMQ
...
## Conexión a Compose for RabbitMQ desde fuera de {{site.data.keyword.cloud_notm}}
