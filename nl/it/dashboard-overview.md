...
![Deployment Details](./images/rabbitmq-deployment-details.png "Una vista del pannello dei dettagli della distribuzione")
...
Puoi gestire il tuo servizio {{site.data.keyword.composeForRabbitMQ}} tramite l'API {{site.data.keyword.cloud_notm}} Compose.
