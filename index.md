...
## Connecting an {{site.data.keyword.cloud_notm}} application to Compose for RabbitMQ
...
## Connecting to Compose for RabbitMQ from outside {{site.data.keyword.cloud_notm}}
